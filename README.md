...
I'm a Senior Quality Engineer based in Hamburg, Germany. 10+ years across QA,
test automation, and software engineering. Currently working on
LLM and AI systems evaluation.

Improving quality is risk reduction: building for testability,
getting feedback early, and asking whether what we measure reflects what matters.

### What's here

- **[review-sentiment-eval](https://github.com/gsiam/review-sentiment-eval)**
An evaluation suite for an LLM-based review analysis system. Covers
summarization faithfulness and prompt injection robustness, with
...
intentional 5% payment failure with a single retry, taking false alarms from 5% to 0.25%.
...
[LinkedIn](https://linkedin.com/in/gsiam) ·  [Ministry of Testing](https://www.ministryoftesting.com/p/giorgos.s)
